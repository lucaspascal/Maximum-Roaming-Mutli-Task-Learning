...
class SegNet(nn.Module):
    def __init__(self):
        ...
        self.class_nb = 13
        self.weights = torch.nn.Parameter(torch.ones(15, dtype=torch.float32), requires_grad=True)
...
while epoch < total_epoch:
    ...
    for k in range(nb_train_batches):
        ...
        task_losses = model.model_fit(train_pred[0], train_label, train_pred[1], train_depth, train_pred[2], train_normal)
